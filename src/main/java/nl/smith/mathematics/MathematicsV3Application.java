...
public class MathematicsV3Application {
    ...
    public static void main(String[] args) {
        ...
        RationalNumber.setScale(150);
        System.out.println("Calculate sin(𝝅/4) using Taylor series:");
        for (int i = 0; i < 50; i++) {
            TaylorSeries.setDegreeOfPolynomial(i);
            System.out.println("Taylor (" + TaylorSeries.getDegreeOfPolynomial() + "): " + rationalNumberGoniometricFunctions.sin(RationalNumber.valueOf("0.785398163397448")));
        }
        System.out.println();
